...
fn main() {
    ...
    // Copy the dll needed for workshopper. Hide the error for release builds to work.
    let _ = std::fs::copy("./../workshopper/3rdparty/steam_api64.dll", "./../target/debug/steam_api64.dll");
